...
var Parser = /*#__PURE__*/function () {
  ...
  _createClass(Parser, [{
    ...
    value: function functionCall() {
      if (this.look().type === _token2.TokenType.RESERVED_FUNCTION_NAME && this.look(1).text === '(') {
        return {
    ...
    value: function arraySubscript() {
      if ((this.look().type === _token2.TokenType.RESERVED_KEYWORD || this.look().type === _token2.TokenType.IDENTIFIER) && this.look(1).text === '[') {
        return {
    ...
    value: function allColumnsAsterisk() {
      if (this.look().text === '*' && _token2.isToken.SELECT(this.look(-1))) {
        this.next();
        return {
